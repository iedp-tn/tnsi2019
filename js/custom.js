...
(function() {
    ...
    /* Background Image on each Section
     ========================================================================== */
    $(".section-homepage.static").backstretch("images/background/bg1.jpg");
    $(".section-about").backstretch("../images/background/bg2.jpg");
    $(".section-contact").backstretch("../images/background/bg3.jpg");
